    ...
    <div class="container-fluid my-5">
        <div class="rounded align-items-center bg-light justify-content-center mx-0">
            ...
            <a class="text-center btn btn-success my-3 w-25" href="../monthly_journal/mjournal.php"><i class="fa fa-circle-arrow-left w-100"></i><b>  Monthly Journal</b></a>
                ...
                <form action="des_search.php" method="get">
        ...
        echo   $msg = '
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        <i class="fa fa-exclamation-circle me-2"></i>New Customer Added!
                ...
                <div id="search-results">
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            <h5 class="text-center my-3 text-primary rounded p-2 bg-white">Silver Customers List</h5>
                            <?php
                            $sql = "SELECT * FROM `customer` where `role`= 'Silver Customer' order by customer.date DESC";
                            ...
                            ?>
                                    <tr class="text-center">
                                        ...
                                        <td><?= $emp['email'] ?></td>
                                        <td><?= $emp['loc'] ?></td>
                                        <td class="text-center"><a class=" btn btn-sm btn-success" href="deb_des.php?t=<?= $emp['id']; ?>"><i class="far fa-plus"></i> Debit (بردگی)</a></td>
                                        <td class="text-center"><a class=" btn btn-sm btn-primary" href="cre_des.php?id=<?= $emp['id']; ?>"><i class="far fa-plus"></i> Credit (رسیدگی)</a></td>
                                    </tr>
                            <?php
                                }
                            } else {
