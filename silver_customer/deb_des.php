...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '$price', '0', 'Silver Customer', 'Cash', 'Debit', '0')";
        mysqli_query($conn, $crea);

        $stah = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id', '$ref', '0', '0', '$price', 'Debit', 'Cash', 'PAID <br> ($price$ BY Reference NO. $ref)')";
        ...
        ';
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '0', '$gold', 'Silver Customer', 'Cash', 'Debit', '0')";
        mysqli_query($conn, $crea);

        $stah = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id', '$ref', '0', '$gold', '0', 'Debit', 'Cash', 'SILVER SOLD <br> ($gold KGS)')";
        mysqli_query($conn, $stah);
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header text-center bg-primary">
                                <h3 class="text-white mt-2">Add Silver Customer Discount Debit Money and gold </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 my-2">
                                        <div class="form-group">
                                            <label class="text-primary" for="price">Silver KGS</label>
                                            <input type="text" class="form-control" id="gold" name="gold" placeholder="Enter Silver Here">
                                        </div>
                                    </div>
