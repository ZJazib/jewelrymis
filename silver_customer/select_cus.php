                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr class="text-center">
                                        ...
                                        <td><?= $emp['email'] ?></td>
                                        <td><?= $emp['loc'] ?></td>
                                        <td class="text-center"><a class=" btn btn-sm btn-success" href="cus_deb.php?t=<?= $emp['id']; ?>"><i class="far fa-plus"></i> Debit (بردگی)</a></td>
                                        <td class="text-center"><a class=" btn btn-sm btn-light" href="cus_cre.php?t=<?= $emp['id']; ?>"><i class="far fa-plus"></i> Credit (رسیدگی)</a></td>
                                    </tr>
                            <?php
                                }
                            } else {
