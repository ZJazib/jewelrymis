...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '$price', '0', 'Silver Customer', 'Cash', 'Credit', '0')";
        mysqli_query($conn, $crea);

        $stah = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id', '$ref', '0', '0', '$price', 'Credit', 'Cash', 'Receipt <br> ($price$ )')";
        ...
        ';
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '0', '$gold', 'Silver Customer', 'Cash', 'Credit', '0')";
        mysqli_query($conn, $crea);

        $stah = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id', '$ref', '0', '$gold', '0', 'Credit', 'Cash', 'JEWELLERY ISSUED <br> ($gold KGS )')";
        mysqli_query($conn, $stah);
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header text-center bg-primary">
                                <h3 class="text-white mt-2">Add Silver Silver Customer Discount Debit Money and gold </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
