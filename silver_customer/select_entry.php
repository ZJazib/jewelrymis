        ...
        echo   $msg = '
                ...
                <div id="search-results">
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            <h5 class="text-center my-3 text-primary rounded p-2 bg-white">Al List</h5>
                            <?php
                            ...
                            ?>
                                    <tr class="text-white bg-dark text-center">
                                        ...
                                        <td><?= $emp['email'] ?></td>
                                        <td><?= $emp['loc'] ?></td>
                                        <td class="text-center"><a class=" btn btn-sm btn-success" href="entry_cus.php?id=<?= $emp['id']; ?>"><i class="far fa-plus"></i> Credit (جــــــــــــمع)</a></td>
                                        <td class="text-center"><a class=" btn btn-sm btn-light" href="debit.php?id=<?= $emp['id']; ?>"><i class="far fa-plus"></i> Debit (نـــــــــــــام </a></td>
