...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        if ($pas == "Cash") {
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$price','0','Customer','$Paid','Credit','$com')";
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-md-4 my-2">
                                                <div class="form-group">
                                                    <label class="text-primary" for="ids">Name</label>
