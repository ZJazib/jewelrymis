...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        if ($Paidc == "Cash") {
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','$price','0','0','Customer','$Paid','Debit','$com')";
            ...
            <div class="alert alert-info alert-dismissible fade show" role="alert">
                <i class="fa fa-exclamation-circle me-2"></i>Customer Debit Money Added!
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        ';
        } else if ($Paidc == "in Account") {

            $cre = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','$totalcc','0','0','Customer','$Paid','Debit','$com')";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="card">
                                <div class="card-header text-center bg-primary ">
                                    <h3 class="text-white mt-2">Add Customer Debit Money</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
