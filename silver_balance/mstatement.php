...
<body class="bg-light">
    ...
    function getAllCustomerBalances($conn, $fromDate, $toDate)
    {
        ...
        $sql = "
            ...
            WHERE 
            c.role IN ('Silver Customer', 'Silver Supplier')";
    ...
    <div class="container-fluid my-5">
      ...
      <table class="table table-bordered my-4">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sqlt = "SELECT SUM(st_price) as totaldebit FROM `storage` where `method` = 'Debit' and `type` = 'Cash' and `name`='SILVER'";
                                    $rest = mysqli_query($conn, $sqlt);
                                    $cust = mysqli_fetch_assoc($rest);


                                    $sqltt = "SELECT SUM(st_price) as totalcredit FROM `storage` where `method` = 'Credit' and `type` = 'Cash' and `name`='SILVER'";
