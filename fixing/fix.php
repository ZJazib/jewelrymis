...
<body class="bg-light">
    ...
    if (isset($_POST['innew'])) {
        ...
        $cus = "INSERT INTO `customer`(`name`, `phone`, `email`, `nic`, `ref`, `loc`, `role`) VALUES ('$name','$phone','$email','$nic','$ref','$loc','Customer')";
...
if ($type == "Buy") {
                if ($userc['role'] == "Customer") {
                    ...
                    $amoc = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','0','$gold','Customer','Cash','Debit','0')";
                    mysqli_query($conn, $amoc);
                    $amo = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$total','0','Customer','Cash','Credit','0')";
                ...
                if ($userc['role'] == "Supplier") {
                    ...
                    $amoc = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$total','0','Supplier','Cash','Credit','0')";
                    mysqli_query($conn, $amoc);

                    $amo = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','0','$gold','Supplier','Cash','Debit','0')";
                    mysqli_query($conn, $amo);
            ...
            if ($type == "Sell") {
                 if ($userc['role'] == "Customer") {
                    ...
                    $amocc = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','0','$gold','Customer','Cash','Credit','0')";
                    mysqli_query($conn, $amocc);
                    $amoccc = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$total','0','Customer','Cash','Debit','0')";
                ...
                if ($userc['role'] == "Supplier") {
                    ...
                    $amocs = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$total','0','Supplier','Cash','Debit','0')";
                    mysqli_query($conn, $amocs);

                    $amos = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','0','$gold','Supplier','Cash','Credit','0')";
        ...
        if ($cus) {
            ...
            if ($type == "Buy") {
                if ($role == "Customer") {
                    ...
                    $insertAccount(0, 0, $gold, 'Customer', 'Cash', 'Credit');
                    $insertAccount($total, 0, 0, 'Customer', 'Cash', 'Debit');
                    ...
                    $insertAccount(0, $total, 0, 'Supplier', 'Cash', 'Credit');
                    $insertAccount(0, 0, $gold, 'Supplier', 'Cash', 'Debit');
                ...
                if ($role == "Customer") {
                    ...
                    $insertAccount(0, 0, $gold, 'Customer', 'Cash', 'Debit');
                    $insertAccount(0, $total, 0, 'Customer', 'Cash', 'Credit');
                    ...
                    $insertAccount(0, $total, 0, 'Supplier', 'Cash', 'Debit');
                    $insertAccount(0, 0, $gold, 'Supplier', 'Cash', 'Credit');
            ...
            error_log("Customer with ID $id not found.");
        }
    } else {
...
?>
   ...
   $sqli = "SELECT SUM(amount) as total FROM `account` where cus_id =" . $_GET['t'];
        ...
        $sqlckg = "SELECT SUM(gold) as totalckg FROM `account` where `type` = 'Credit' and cus_id=" . $_GET['t'];
        $resckg = mysqli_query($conn, $sqlckg);
        $cusckg = mysqli_fetch_assoc($resckg);
                                            ...
                                            <div class="card">
                                                ...
                                                <script>
                                                    function calculateTotals() {
                                                        ...
                                                        var total = own / 31.1035 * 3.674 / 3.67 * weight;
