...
<body class="bg-light">
    ...
    if (isset($_POST['in'])) {
        ...
        $cre = "INSERT INTO `office`(`of_name`, `of_dis`, `of_money`, `currency`, `ref`, `state`,`type`) VALUES ('$name','$dis','$price','$cur','$ref','$Paid','Credit')";
        mysqli_query($conn, $cre);
         $stah = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$dis','0','0','$price','Credit','$Paid', 'Recepit Of $dis')";
            mysqli_query($conn, $stah);

        $debs = "INSERT INTO `storage`(`st_cus`, `st_price`, `st_gold`, `type`, `method`, `name`) VALUES ('$id','$price','0','$Paid','Credit','Money')";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="card">
                                <div class="card-header text-center bg-primary ">
                                    <h3 class="text-white mt-2">Add New Credit Office Transiction</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
