...
<body class="bg-light">
    ...
    if (isset($_POST['inc'])) {
        $cs = "SELECT * FROM customer WHERE `name`= 'Office'";
        ...
        $cre = "INSERT INTO `office`(`of_name`, `of_dis`, `of_money`, `currency`, `ref`, `state`,`type`) VALUES ('$name','$dis','$price','$cur','$ref','$Paid','Debit')";
        mysqli_query($conn, $cre);
 $stah = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$dis','0','0','$price','Debit','$Paid', 'PAID For $dis')";
            mysqli_query($conn, $stah);
        $debs = "INSERT INTO `storage`(`st_cus`, `st_price`, `st_gold`, `type`, `method`, `name`) VALUES ('$id','$price','0','$Paid','Debit','Money')";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="card">
                                <div class="card-header text-center bg-primary ">
                                    <h3 class="text-white mt-2">Add New Debit Office Transiction</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 my-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Name" value="" name="name" placeholder="Write Name Here">
                                            </div>
                                        </div>
                                        <div class="col-md-4 my-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 my-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="dis" value="" name="dis" placeholder="Write Reference Here">
                                            </div>
                                        </div>
                                        <div class="col-md-4 my-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 my-2">
                                            <div class="form-group">
                                                <label class="text-primary" for="cur">Curency</label>
                                                <select name="cur" id="cur" class="form-select">
                                                    <option value="">Select the curency</option>
                                        ...
                                        <div class="form-group text-center my-2">
                                            <button type="submit" name="inc" class="btn btn-primary "><i class="fa fa-plus rounded-circle bg-white p-1 text-primary mx-1"></i>Insert</button>
