...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '$price', '0', 'Suppiler', 'Cash', 'Credit', '0')";
        ...
        ';
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '0', '$gold', 'Suppiler', 'Cash', 'Credit', '0')";
        mysqli_query($conn, $crea);
