...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '$price', '0', '0', 'Suppiler', 'Cash', 'Debit', '0')";
        ...
        ';
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '0', '$gold', 'Suppiler', 'Cash', 'Debit', '0')";
        mysqli_query($conn, $crea);

        $stah = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id', '$ref', '0', '$gold', '0', 'Debit', 'Cash', 'JEWELLERY SOLD <br> ($gold GMS BY Reference NO. $ref)')";
        mysqli_query($conn, $stah);
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header text-center bg-primary">
                                <h3 class="text-white mt-2">Add Suppiler Discount Credit Money and gold </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
