...
<body class="bg-light">
    ...
    if (isset($_POST['insertn'])) {
        ...
        $deb = "INSERT INTO `debit`(`dep_cus`, `ref`, `dep_tgold`, `dep_tbill`, `dep_tpurity`, `sate`, `com`, `typec`) VALUES ('$id','$ref','$goldg','$mc','$purity','Gold Debit','0','$Paid')";
            $resdb = mysqli_query($conn, $deb);

            $cre = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','$mc','0','$purity','Supplier','$Paid','Debit','0')";
            $res = mysqli_query($conn, $cre);

            $debs = "INSERT INTO `storage`(`st_cus`, `st_price`, `st_gold`, `type`, `method`, `name`) VALUES ('$id','0','$purity','$Paid','Debit','gold')";
            mysqli_query($conn, $debs);

            $sta = "INSERT INTO `statement`(`se_cus`,`ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref','$goldg','$purity','$mc','Debit','$Paid', 'JEWELLERY SOLD <br> (GROSS WT- $goldg GMS)')";
