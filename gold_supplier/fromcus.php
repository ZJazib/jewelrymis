...
<body class="bg-light">
    ...
    if (isset($_POST['insertn'])) {
        ...
        $Paid = $_POST['paid'];
             ...
             // Credit off Customer
        $deb = "INSERT INTO `credit`(`ref`, `cre_cus`, `cre_tgold`, `cre_tbill`, `cre_tpurity`, `ujorat`, `com`, `sate`, `fix`, `role`, `typec`) VALUES ('$dis','$id','0','$mc','0','0','0','Credit','Not','Supplier','$Paid')";
        $resd = mysqli_query($conn, $deb);

        $amo = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$dis','0','$mc','0','Supplier','$Paid','Credit','0')";
        mysqli_query($conn, $amo);

        $staf = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$dis','0','0','$mc','Credit','$Paid', 'Recepit <br> ($mc$ BY Reference NO. $dis)')";
        ...
        $sta = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$ref','$dis','0','0','$mc','Debit','$Paid', 'Paid <br> ($mc$ BY Reference NO. $dis)')";
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header text-center bg-primary">
                                <h3 class="text-white mt-2">Add Money Transiction From Supplier To Supplier</h3>
                            </div>
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 my-2">
                                            <div class="form-group">
                                                ...
                                                <select id="goldnam" name="ref" class="form-select">
                                                    <option value="------">------</option>
        ...
        <div class="container-fluid pt-4 px-5">
            <div class=" rounded align-items-center bg-light justify-content-center mx-0">
                <div class="container py-2">
                    <a class="text-center btn btn-success my-3 w-25" href="../monthly_journal/mjournal.php"><i class="fa fa-circle-arrow-left w-100"></i><b> Monthly Journal</b></a>
                    <a class="text-center btn btn-outline-dark m-3 w-25" href="../index.php"><i class="fa fa-circle-arrow-left w-100"></i><b> Dashboard</b></a>
                    <h4 class="text-center my-4 bg-primary rounded p-2 text-white">Transiction of Money From Supplier To Supplier</h4>
                    ...
                    <div id="search-results">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM `customer` where `role`='Supplier' order by `date` desc";
                                $res = mysqli_query($conn, $sql);
                                if (mysqli_num_rows($res) > 0) {
