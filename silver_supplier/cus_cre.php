...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        if ($pas == "Cash") {
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$price','0','Silver Supplier','$Paid','Credit','$com')";
            ...
            <div class="alert alert-info alert-dismissible fade show" role="alert">
                <i class="fa fa-exclamation-circle me-2"></i>Silver Supplier Credit Money Added!
       ...
       if ($pas == "inaccount") {
            ...
            $cre = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$totalcc','0','Silver Supplier','$Paid','Credit','$com')";
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-header text-center bg-primary ">
                                        <h3 class="text-white mt-2">Add Silver Supplier Credit Money</h3>
                                    </div>
