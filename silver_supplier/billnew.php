...
if (isset($_POST['submit'])) {
    ...
    $amo = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','$bill','0','$goldg','Silver Silver Supplier','Cash','Debit','0')";
    mysqli_query($conn, $amo);

    $debs = "INSERT INTO `storage`(`st_cus`, `st_price`, `st_gold`, `type`, `method`, `name`) VALUES ('$id','0','$goldg','Cash','Debit','SILVER')";
    mysqli_query($conn, $debs);

    $sta = "INSERT INTO `statement`(`se_cus`,`ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref',0,'$goldg','$bill','Debit','Cash', 'SILVER SOLD <br> (WT - $goldg KGS PURITY -  $pur)')";
