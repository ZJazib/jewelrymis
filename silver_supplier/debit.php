...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        $amoc = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','0','$totalg','$role','Cash','Debit','0')";
        ...
        $sta = "INSERT INTO `statement`(`se_cus`,`ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref','$totalg','$totalpure','0','Debit','$Paid', 'JEWELLERY SOLD FOR $name GROSS WT- $totalg GMS')";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="card-header text-center bg-primary">
                                    <h3 class="text-white mt-2">Add Silver Supplier Transiction</h3>
                                </div>
                                <div class="card-body">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 my-2">
                                                <div class="form-group text-center my-2">
                                                    <button type="submit" name="insert" class="btn btn-primary"><i class="fa fa-plus rounded-circle bg-white p-1 text-primary mx-1"></i> Debit (نـــــــــــــام)</button>
