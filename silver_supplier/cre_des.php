...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '$price', '0', 'Silver Supplier', 'Cash', 'Credit', '0')";
        ...
        ';
            ...
            $crea = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id', '$ref', '0', '0', '$gold', 'Silver Supplier', 'Cash', 'Credit', '0')";
        mysqli_query($conn, $crea);
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header text-center bg-primary">
                                <h3 class="text-white mt-2">Add Silver Silver Supplier Discount Debit Money and gold </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
