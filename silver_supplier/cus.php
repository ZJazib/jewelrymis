...
<body class="bg-light">
    ...
    $cus = "INSERT INTO `customer`(`name`, `phone`, `email`, `nic`, `ref`, `loc`, `role`) VALUES ('$name','$phone','$email','$nic','$ref','$loc','Silver Supplier')";
                    ...
                    <div class="row">
                        <div class="card m-2">
                            <div class="card-header text-center bg-primary">
                                <h3 class="text-white mt-2">Add New Silver Supplier</h3>
                            </div>
