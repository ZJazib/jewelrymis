...
<body class="bg-light">
    ...
    if (isset($_POST['insert'])) {
        ...
        if ($Paidc == "Cash") {
            ...
            $crev = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$price','0','Money Supplier','$Paid','Credit','0')";
            $resv = mysqli_query($conn, $crev);

            $debsv = "INSERT INTO `storage`(`st_cus`, `st_price`, `st_gold`, `type`, `method`, `name`) VALUES ('$id','$totalk','0','$Paid','Credit','Money')";
            mysqli_query($conn, $debsv);

            $stav = "INSERT INTO `statement`(`se_cus`,`ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref','0','0','$price','Credit','$Paid', 'CURRENCY JV ($price $ By Reference NO. $ref)')";
            mysqli_query($conn, $stav);
        } else if ($Paidc == "in Account") {

            $cre = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','0','$totalcc','0','Money Supplier','$Paid','Credit','0')";
            ...
            $sta = "INSERT INTO `statement`(`se_cus`,`ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref','0','0','$totalcc','Credit','$Paid', 'CURRENCY JV ($price $ By Reference NO. $ref)')";
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header text-center bg-primary ">
                                <h3 class="text-white mt-2">Add Money Supplier Debit</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
