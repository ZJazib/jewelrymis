    ...
    ?>
        ...
        if (isset($_POST['insert'])) {
            ...
            if ($Paidc == "Cash") {
                ...
                $crev = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','$price','0','0','Money Supplier','$Paid','Debit','0')";
                $res = mysqli_query($conn, $crev);

                $debsv = "INSERT INTO `storage`(`st_cus`, `st_price`, `st_gold`, `type`, `method`, `name`) VALUES ('$id','$totalk','0','$Paid','Debit','Money')";
                mysqli_query($conn, $debsv);

                $stav = "INSERT INTO `statement`(`se_cus`,`ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref','0','0','$price','Debit','$Paid', 'Paid <br> ($price$ BY Reference NO. $ref )')";
                mysqli_query($conn, $stav);
            }
            else if ($Paidc == "in Account") {

                $cre = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$id','$ref','$totalcc','0','0','Money Supplier','$Paid','Debit','0')";
                $res = mysqli_query($conn, $cre);

                $debs = "INSERT INTO `storage`(`st_cus`, `st_price`, `st_gold`, `type`, `method`, `name`) VALUES ('$id','$totalcc','0','$Paid','Debit','Money')";
                mysqli_query($conn, $debs);

                $sta = "INSERT INTO `statement`(`se_cus`,`ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref','0','0','$totalcc','Debit','$Paid', 'Paid <br> ($price$ BY Reference NO. $ref )'";
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="card">
                                        <div class="card-header text-center bg-primary ">
                                            <h3 class="text-white mt-2">Add Money Supplier Credit</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 my-2">
                                                    <div class="form-group">
                                                        <label class="text-primary" for="Reference">Reference Number</label>
