...
<body class="bg-light">
    ...
    if (isset($_POST['insertn'])) {
        ...
        // money Supplier
            ...
            $amo = "INSERT INTO `account`(`cus_id`, `ref`, `amount`, `amo_cre`, `gold`, `role`, `state`, `type`, `com`) VALUES ('$gold','$ref','$moa','0','0','Money Supplier','$Paid','Debit','0')";
                                        ...
                                        <div class="col-md-4 my-2">
                                            <div class="form-group">
                                                ...
                                                <select id="gold" name="gold" class="form-select">
                                                    <option value="------">------</option>
                                                    <?php $sql = "SELECT * FROM `customer` where `role` = 'Money Supplier'";
                                                    $res = mysqli_query($conn, $sql);
