...
<body class="bg-light">
    ...
    if (isset($_POST['insertn'])) {
        ...
        // money Supplier
            ...
            $stacc = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$id','$ref','0','0','$moac','Credit','$Paid', 'Paid <br> ($moa$ TO MESSAGE NO. $ref With COM $com)')";
            ...
            $sta = "INSERT INTO `statement`(`se_cus`, `ref`, `se_tgolg`, `se_tpurity`, `se_tbill`, `se_type`, `se_method`, `dis`) VALUES ('$gold','$ref','0','0','$moa','Debit','$Paid', 'Recepit <br> ($moa$ FROM MESSAGE NO. $ref )')";
            mysqli_query($conn, $sta);
