...
<body> <?php if (!empty($_GET['from'])) {
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <thead> <br>
                    <tr class="text-center">
                        ...
                        <th width="157.8" colspan="3">Gold Quantity (CT)</th>
                    </tr>
                    <tr>
            ...
            <div> <strong>Total Gold Balance: </strong> <?= ($goldBalance != 0) ? ($goldBalance < 0 ? number_format(abs($goldBalance), 3) : number_format($goldBalance, 3)) : '' ?> <?php echo ($goldCreditTotal > $goldDebitTotal) ? "Credit" : "Debit"; ?> </div>
            ...
            <div> <strong>Total Gold Balance: </strong> <?= ($goldBalance != 0) ? ($goldBalance < 0 ? number_format(abs($goldBalance), 3) : number_format($goldBalance, 3)) : '0.000' ?> <?php echo ($goldCreditTotal > $goldDebitTotal) ? "Credit" : "Debit"; ?> </div>
        </div> <?php }
