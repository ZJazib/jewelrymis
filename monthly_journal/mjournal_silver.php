          ...
          <div class="container py-2">
            ...
            <div class="row">
              ...
              <div class="col-md-4 bg-dark rounded">
                ...
                ?>
                <h5 class="text-white px-4">Credit Silver: <span> <?= number_format($totalckg, 3) ?></span></h5>

                <h5 class="text-white px-4">Debit Silver: <span> <?= number_format($totalkg, 3) ?> </span> </h5>
                <h5 class="text-white ">
                  <?php
            ...
            <a href="statment_silver.php?id=<?= $id ?>&from=<?= $from ?>&to=<?= $to ?>" class="btn btn-success w-25 m-2"><i class="far fa-file"></i> Generate Statement</a>
            ...
            <div class="table-responsive ">
              <table class="table text-start align-middle table-bordered table-hover mb-0">
                <thead>
                  <tr class="text-white bg-primary text-center">
                    <th colspan="8" class="bg-dark text-white">
                      <h5 class="text-center bg-dark text-white">Debit Silver (بردگی طلا) </h5>
                    </th>
                  </tr>
                  <tr class="text-white bg-primary text-center">
                ...
                <tbody>
                  ...
                  <tr class="text-white bg-primary text-center">
                    <th colspan="8" class="bg-dark text-white">
                      <h5 class="text-center bg-dark text-white">Credit Silver (رسیدگی طلا)</h5>
                    </th>
                  </tr>
                  <tr class="text-white bg-primary text-center">
                    <th scope="col">Role</th>
                    <th scope="col">Name</th>
                    <th scope="col">Reference</th>
                    <th scope="col">Total Silver Grams</th>
                    <th scope="col">Total Price</th>
      ...
      <div class="container py-2">
        ...
        <div class="row">
          ...
          <div class="col-md-4 bg-dark rounded">
            ...
            ?>
            <h5 class="text-white px-4">Credit Silver: <span><?= number_format($total_credit_gold, 3); ?></span></h5>
            <h5 class="text-white px-4">Debit Silver: <span><?= number_format($total_debit_gold, 3); ?></span></h5>
            <h5 class="text-white px-4">
              <?php
    ...
    <i class="far fa-file"></i> Generate Statement
        ...
        if (!empty($_GET['from'])) {
          ...
          <div class="table-responsive ">
            <table class="table text-start align-middle table-bordered table-hover mb-0">
              <thead>
                <tr class="text-white bg-primary text-center">
                  ...
                  <th colspan="3">Silver Qty. In CT</th>
            ...
            <div>
              <strong>Total Silver Balance: </strong>
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
              <thead>
                <tr class="text-white bg-primary text-center">
                  ...
                  <th colspan="3">Silver Quantity (CT)</th>
