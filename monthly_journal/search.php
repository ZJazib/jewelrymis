...
if (isset($_GET['jbm'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<th>Role</th><th>Name</th><th>NIC</th><th>Phone</th><th>Email</th><th>Location</th><th>Action</th>';
        echo '</tr></thead><tbody>';
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>' . $row['loc'] . '</td>';
            echo '<td><a class="btn btn-sm btn-success" href="mjournal.php?id=' . $row['id'] . '"><i class="far fa-eye"></i></a></td>';
            echo '</tr>';
        }
        echo '</tbody></table>';
    } else {
